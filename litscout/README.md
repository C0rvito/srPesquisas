...
- **research_sessions** — one per `litscout search` run
...
litscout search "Carvacrol antimicrobial"

# Top 5 only, skip scholarly
litscout search "Thymol antifungal" --top 5 --no-scholarly

# Dry run (no DB write)
litscout search "Eugenol" --dry-run
