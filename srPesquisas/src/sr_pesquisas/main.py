...
from sr_pesquisas.agents.analyzer import ArticleAnalyzer
from sr_pesquisas.agents.pipeline import run_pipeline
from sr_pesquisas.config import settings
from sr_pesquisas.database.engine import db_session, init_db
from sr_pesquisas.database.repository import (
    ArticleRepository,
    InteractionRepository,
    SessionRepository,
)
from sr_pesquisas.ui.browser import browse_database_articles
from sr_pesquisas.ui.display import (
    console,
    display_articles,
...
app = typer.Typer(
    help="🔬 srPesquisas: Buscador acadêmico inteligente focado em cito-toxicidade.",
...
def main(ctx: typer.Context):
    """
    srPesquisas: Ferramenta de pesquisa acadêmica com IA.
    """
